...
public class HorseLand {
    ...
    public static void main(String[] args) {
        ...
        // entered the info for each string
        Horse firstHorse;
        ...
        //prints out discrption for each horse
        System.out.println("********************");
        ...
        System.out.println("********************");
        //gives an if else to let the user chose what horse they want
        ...
        //calls the array to give the random winner of the race
